...
public class Komplectuyushie extends AppCompatActivity implements LoadListener, LoadListenerCart {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_komplectuyushie);
        init();
        loadFromFirebase();
        countCartItem();
    }
