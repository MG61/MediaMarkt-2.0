...
public class PuzzlesCatFire extends AppCompatActivity implements LoadListener, LoadListenerCart {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_puzzles_cat_fire);
        init();
        loadFromFirebase();
        countCartItem();
    }
