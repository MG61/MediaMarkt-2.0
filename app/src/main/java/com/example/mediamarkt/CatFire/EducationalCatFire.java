...
public class EducationalCatFire extends AppCompatActivity implements LoadListener, LoadListenerCart {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_educational_cat_fire);
        init();
        loadFromFirebase();
        countCartItem();
    }
